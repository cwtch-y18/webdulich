$(document).ready(function(){
     ...
     *              PAGE LOGIN              *
     * ***************************************/
    //handle click sign up and sign in
...
//     if (!emailPattern.test(email)) {
//         $("#error-email").show().text("Email không hợp lệ");
//         isValid = false;
//     }

//     // validate password
//     if (password.length < 6) {
//         $("#error-password").show().text("Mật khẩu ít nhất 6 ký tự");
//         isValid = false;
//     }

//     if (password !== passwordConfirm) {
//         $("#error-password-confirm").show().text("Mật khẩu không khớp");
//         isValid = false;
//     }
...
//         complete: function () {
//             $(".loader").hide();
//             $("#reset_password").removeClass("hidden-content");
//         }
//     });
// });
...
$(".clear_filter a").on("click", function (e) {
    ...
    // Gọi lại filterTours để load toàn bộ tour
    filterTours();
});
    /****************************************
     *             PAGE USER-PROFILE        *
