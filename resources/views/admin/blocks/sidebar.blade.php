@php
    ...
    $permissions = auth('admin')->user()->getPermissions();
@endphp
    ...
    <div class="left_col scroll-view">
        ...
        <div class="profile clearfix">
            <div class="profile_pic">
                <img src="{{ asset('admin/assets/images/user-profile/' . auth('admin')->user()->avatar) }}" alt="..."
                    style="width:60px; height:60px; object-fit: cover;" class="img-circle profile_img">
            </div>
            ...
            <div class="menu_section">
                ...
                <ul class="nav side-menu">
                    ...
                    @if(in_array('manage_user', $permissions))
                        <li>
                            <a href="{{ route('admin.users') }}"><i class="fa fa-users"></i>Quản lý người dùng</a>
                        </li>
                    @endif
                    ...
                    @if(in_array('manage_booking', $permissions))
            ...
            <ul class=" navbar-right">
                <li class="nav-item dropdown open" style="padding-left: 15px;">
                    <a href="javascript:;" class="user-profile dropdown-toggle" aria-haspopup="true" id="navbarDropdown"
                        ...
                        <img src="{{ asset('admin/assets/images/user-profile/' . auth('admin')->user()->avatar) }}"
