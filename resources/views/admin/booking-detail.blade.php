                                    ...
                                    <section class="content invoice">
                                        ...
                                        <div class="row">
                                            <div class="  invoice-header">
                                                <h3>
                                                    <img src="{{ asset('admin/assets/images/icon/favicon.png') }} "
                                                        alt="" 
                                                        style="margin-right: 10px; width: 60px; height: 55px;">{{ $invoice_booking->title }}
                                        ...
                                        <div class="row invoice-info">
                                            ...
                                            <div class="col-sm-4 invoice-col">
                                                Đến
                                                <address>
                                                    <strong>Công ty NamVietTravel</strong>
                                                    <br>Hà Nội
                                                    <br>City
                                                    <br>Phone: 1 (804) 123-9876
                                                    <br>Email: NamVietTravel@gmail.com
                                                </address>
                                            </div>
                                            <!-- /.col -->
                                            <div class="col-sm-4 invoice-col">
                                                ...
                                                <br>
                                                <b>Tài khoản:</b> {{ $invoice_booking->id }}
                                            </div>
                                            <!-- /.col -->
                                        </div>
                                        <!-- /.row -->
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                @else
                                                    <img src="{{ asset('admin/assets/images/icon/favicon.png') }}"
                                                        alt="" style="width:60px; height: 55px;">
