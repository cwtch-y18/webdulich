...
<p style="font-size: 16px; font-family: Arial, sans-serif; color: #333;">Cảm ơn bạn đã đặt tour tại NamVietTravel. Vui lòng xem chi tiết hóa đơn trong file đính kèm.</p>
        ...
        <section class="content invoice">
            ...
            <div class="row invoice-info" style="margin-bottom: 20px;">
                ...
                <div class="col-sm-4 invoice-col" style="font-size: 14px;">
                    Đến
                    <address>
                        <strong>Công ty NamVietTravel</strong><br>
                        470 Trần Đại Nghĩa<br>
                        Đại Từ Đại Bi<br>
                        Phone: 1 (804) 123-9876<br>
                        Email: lyybui814@gmail.com
                    </address>
                </div>
                <br>
                <div class="col-sm-4 invoice-col" style="font-size: 14px;">
