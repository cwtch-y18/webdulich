                            ...
                            <div class="x_content">
                                <div class="col-md-3 col-sm-3  profile_left">
                                    <div class="profile_img">
                                        <div id="crop-avatar">
                                            <div class="avatar-wrapper" style="display: flex;justify-content: center;align-items: center;overflow: hidden;width: 300px;height: 300px;">
                                            <!-- Current avatar -->
                                            <img id="avatarAdminPreview" class="img-responsive avatar-view"
                                                  src="{{ asset('admin/assets/images/user-profile/' . auth('admin')->user()->avatar) }}" alt="..."
                                                 style="width:300px; height:300px;object-fit: cover; " title="Change the avatar">
                                ...
                                <div class="col-md-9 col-sm-9 ">
                                    <form action="{{ route('admin.update-admin') }}" id="formProfileAdmin" method ='post'
