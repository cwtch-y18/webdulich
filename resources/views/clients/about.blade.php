        ...
        <div class="row justify-content-center">
            ...
            <div class="col-xl-3 col-lg-4 col-sm-6">
                <div class="team-item hover-content" data-aos="fade-up" data-aos-duration="1500"
                    ...
                    <div class="content">
                        <h6>BUI THI THUY LY</h6>
                        <span class="designation">Founder</span>
                        <div class="social-style-one inner-content">
                            <a href="contact.html"><i class="fab fa-twitter"></i></a>
                            <a href="https://www.facebook.com/NamViet"><i class="fab fa-facebook-f"></i></a>
                            <a href="contact.html"><i class="fab fa-instagram"></i></a>
                            <a href="https://www.youtube.com/NamViet"><i class="fab fa-youtube"></i></a>
                        </div>
                    </div>
                </div>
            </div>
