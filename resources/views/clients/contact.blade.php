...
@include('clients.blocks.banner')
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="contact-info-item" data-aos="fade-up" data-aos-duration="1500" data-aos-offset="50" data-aos-delay="50">
                                    ...
                                    <div class="content">
                                        ...
                                        <div class="text"><i class="far fa-envelope"></i> <a href="mailto:lyybui814@gmail.com">lyybui814@gmail.com</a></div>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="contact-info-item" data-aos="fade-up" data-aos-duration="1500" data-aos-offset="50" data-aos-delay="100">
                                    ...
                                    <div class="content">
                                        <h5>Cần bất kì việc khẩn cấp nào</h5>
                            ...
                            <div class="col-md-6">
                                <div class="contact-info-item" data-aos="fade-up" data-aos-duration="1500" data-aos-offset="50" data-aos-delay="50">
                                    ...
                                    <div class="content">
                                        <h5>Hà Nội</h5>
                                        <div class="text"><i class="fal fa-map-marker-alt"></i>Km3+350 đường Phan Trọng Tuệ, Thanh Trì, Hà Nội </div>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
                    ...
                    <div class="col-lg-5">
                        <div class="contact-images-part" data-aos="fade-right" data-aos-duration="1500" data-aos-offset="50">
                            ...
                            <div class="circle-logo">
                                ...
                                <span class="title h2">NamViet</span>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="contact-map">
            <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3726.0788105939455!2d105.81959267471233!3d20.94934999050235!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3135add7a98d2c1d%3A0xe60529400caa5c57!2zVHLGsOG7nW5nIENhbyDEkOG6s25nIEPDtG5nIE5naOG7hyBCw6FjaCBLaG9hIEjDoCBO4buZaSBD4bufIFPhu58gVGhhbmggVHLDrA!5e0!3m2!1svi!2s!4v1770171765635!5m2!1svi!2s" style="border:0; width: 100%;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
        </div>
        <!-- Contact Map End -->    
