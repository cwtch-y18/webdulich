        ...
        <div class="row gap-10 justify-content-center rel">
            <div class="col-lg-4 col-md-6">
                <div class="gallery-item">
                    <img src="{{ asset('admin/assets/images/gallery-tours/' . ($images->get(0) ?? 'default.jpg')) }}">
                </div>
                <div class="gallery-item">
                    <img src="{{ asset('admin/assets/images/gallery-tours/' . ($images->get(1) ?? 'default.jpg')) }}">
                </div>
            </div>
            <div class="col-lg-4 col-md-6">
                <div class="gallery-item gallery-between">
                    <img src="{{ asset('admin/assets/images/gallery-tours/' . ($images->get(2) ?? 'default.jpg')) }}">
                </div>
            </div>
            <div class="col-lg-4 col-md-6">
                <div class="gallery-item">
                    <img src="{{ asset('admin/assets/images/gallery-tours/' . ($images->get(3) ?? 'default.jpg')) }}">
                </div>
                <div class="gallery-item">
                    <img src="{{ asset('admin/assets/images/gallery-tours/' . ($images->get(4) ?? 'default.jpg')) }}">
                </div>
            </div>
        </div>
    </div>
                ...
                <div class="blog-sidebar tour-sidebar">
                    ...
                    <div class="widget widget-contact" data-aos="fade-up" data-aos-duration="1500" data-aos-offset="50">
                        ...
                        <ul class="list-style-one">
                            <li><i class="far fa-envelope"></i> <a href="lyybui814@gmail.com">lyybui814@gmail.com</a>
                            </li>
