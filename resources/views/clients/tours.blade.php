            ...
            <div class="col-lg-3 col-md-6 col-sm-10 rmb-75">
                <div class="shop-sidebar">
                    ...
                    <div class="widget widget-activity" data-aos="fade-up" data-aos-duration="1500"
                        data-aos-offset="50">
                        <h6 class="widget-title">Hoạt động</h6>
                        <ul class="radio-filter">
                            <li>
                                <input class="form-check-input" type="radio" name="domain" id="id_mien_bac" value="b">
                                <label for="id_mien_bac">Miền Bắc
                                    <span>{{ $domainsCount['mien_bac'] ?? 0 }}</span></label>
                            </li>
                            <li>
                            ...
                            <li>
                                ...
                                <label for="id_mien_nam">Miền Nam
                                    <span>{{ $domainsCount['mien_nam'] ?? 0 }}</span></label>
                            </li>
                        </ul>
                    </div>
        ...
        <div class="col-lg-9">
            <div class="shop-shorter rel z-3 mb-20">
                ...
                <div class="sort-text mb-15 me-4 me-xl-auto">
                    Đã tìm thấy <span>34</span> kết quả
                </div>
