                    ...
                    <div class="col-xl-5 col-lg-6">
                        <div class="mobile-app-content rmb-55" data-aos="fade-up" data-aos-duration="1500" data-aos-offset="50">
                            <div class="section-title counter-text-wrap mb-40">
                                <h2>Cẩm nang thám hiểm: Hướng dẫn toàn diện cho mọi hành trình của bạn</h2>
                            </div>
                            ...
                            <ul class="list-style-two mt-35 mb-30">
                                ...
                                <li>Trải nghiệm cơ bản</li>
                            </ul>
                            <a href="about.html" class="theme-btn style-two">
                                <span data-hover="Explore Guides">Xem tất cả </span>
                ...
                <div class="row justify-content-center">
                    <div class="col-lg-12">
                        <div class="section-title text-center counter-text-wrap mb-50" data-aos="fade-up" data-aos-duration="1500" data-aos-offset="50">
                            <h2>Gặp gỡ những hướng dẫn viên giàu kinh nghiệm và nhiệt huyết </h2>
                            <p>Website với <span class="count-text plus bgc-primary" data-speed="3000" data-stop="34500">0</span> trải nghiệm phổ biến mà bạn sẽ nhớ mãi</p>
                        </div>
                    </div>
                </div>
                <div class="row justify-content-center">
